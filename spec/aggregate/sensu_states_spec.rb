...
require 'spec_helper'
require File.join(File.dirname(__FILE__), "../../", "aggregate", "sensu_states")

module MCollective
  class Aggregate
    describe Sensu_states do
      describe "#startup_hook" do
        it "should set the correct result hash" do
          result = Sensu_states.new(:test, [], "%d", :test_action)
        ...
        it "should set a default aggregate format" do
          result = Sensu_states.new(:test, [], nil, :test_action)
      ...
      describe "process_result" do
        ...
        it "should add to the 'unkown' field if check result is undefined" do
          result = Sensu_states.new(:test, [], nil, :test_action)
